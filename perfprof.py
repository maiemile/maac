...
This code has originally been implemented by Daniel Steck: https://github.com/dmsteck/perfprof.py/tree/master
Some minor edits have been made by @maiemile
...
def _make_staircase(theta, m, thmax, tol):
    ...
    # don't draw the last horizontal line if the line reaches the value 1 on the y axis
    if prob[-1] < 1 - tol:
        x = np.append(x, thmax)
