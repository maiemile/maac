...
if __name__ == "__main__":
    ...
    pipeline = ["generate_database", "run_experiments", "approx_pf"]#["approx_pf", "generate_database", "run_experiments", "calculate_indicators"]
    ...
    problem_instances = [
        ...
        #["dtlz1", 3, 7],
        #["dtlz2", 3, 10],["dtlz3", 3, 10],["dtlz4", 3, 10],["dtlz5", 3, 10],["dtlz6", 3, 10],["dtlz7", 3, 10],
        #["dtlz1", 4, 11],["dtlz2", 4, 15],["dtlz3", 4, 15],["dtlz4", 4, 15],["dtlz5", 4, 15],["dtlz6", 4, 15],["dtlz7", 4, 15], #DTLZ5-7 with 4 objectives doesn't work, "not implemented yet" in pymoo
        ...
        #["wfg1", 3, 10],
        #["wfg2", 3, 10],["wfg3", 3, 10],["wfg4", 3, 10],["wfg5", 3, 10],["wfg6", 3, 10],["wfg7", 3, 10],["wfg8", 3, 10],["wfg9", 3, 10],
    ...
    if "generate_database" in pipeline:
        generate_database.do(setup, indicators=indicators, n_of_repeats=[1], target_evals=[10000])
