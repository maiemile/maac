...
#SBATCH --time=06:00:00             # Maximum duration of the job. Upper limit depends on partition.
...
srun /projappl/XXXXXX/DESDEO/DESDEO/.venv/bin/python run_experiments.py